...
PyMODINIT_FUNC
PyInit__cffi__x671c885ax9eb600ef(void)
{
  PyObject *lib;
...
PyMODINIT_FUNC
init_cffi__x671c885ax9eb600ef(void)
{
  PyObject *lib;
  lib = Py_InitModule("_cffi__x671c885ax9eb600ef", _cffi_methods);
  if (lib == NULL)
    return;
  if (((void)lib,0) < 0 || _cffi_init() < 0)
    return;
