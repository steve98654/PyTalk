...
PyMODINIT_FUNC
PyInit__cffi__xe1fda0dbx9fa62f06(void)
{
  PyObject *lib;
...
PyMODINIT_FUNC
init_cffi__xe1fda0dbx9fa62f06(void)
{
  PyObject *lib;
  lib = Py_InitModule("_cffi__xe1fda0dbx9fa62f06", _cffi_methods);
  if (lib == NULL)
    return;
  if (((void)lib,0) < 0 || _cffi_init() < 0)
    return;
